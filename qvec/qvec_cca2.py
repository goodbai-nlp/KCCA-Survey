...
parser.add_argument("--in_oracle", default="/home/xfbai/mywork/git/KCCA-Experiment/qvec/oracles/semcor_noun_verb.supersenses.en", help="comma-separated list of linguistic annotation files, each is in format word \\t json dictionary of linguistic features")
