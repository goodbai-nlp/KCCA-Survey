...
parser.add_argument("--in_vectors", default="/home/xfbai/mywork/git/KCCA-Experiment/Output/KCCA_en_out.txt")
parser.add_argument("--in_oracle", default="/home/xfbai/mywork/git/KCCA-Experiment/evalution/qvec/oracles/semcor_noun_verb.supersenses.en", help="comma-separated list of linguistic annotation files, each is in format word \\t json dictionary of linguistic features")
